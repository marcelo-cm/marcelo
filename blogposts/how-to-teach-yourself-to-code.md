...
In this guide are a lot of terms you may not know, so I've linked basic descriptions of it for you to dive into it.

Below are the basic steps of the journey — This is an **EXTREMELY** condensed timeline, so I wouldn't recommend skipping steps because we're already skipping a ton. I've keep it very concise on purpose; I am happy to answer questions, provide clarity, or give advise if you're ever stuck. Email me at [marcechmaman@gmail.com](mailto:marcechaman@gmail.com).

# STEP 1 — Learn Syntax

You must understand how code works. You must understand the different 'grammatical structure' or 'syntax' of code before you can rely on tools to do it for you. Thus, using resources like [Codecademy](https://www.codecademy.com/), you will learn the basics of programming. Learn the following:

- **HTML/CSS** — The building blocks of any thing on the web.
...
- **Bash/Terminal/CLI** — Whatever your computer's terminal language is. This will help you navigate your computer and give you a base understanding of directories.

If you dedicate your time to this, you can learn the basics to all of these within 4-6 weeks (about 1 week to dive into each).
...
At this stage, you should know how to program at a basic level, and have the tools to do build something. However, this is the steepest part of your learning curve — you are going to learn a TON. Therefore, you should be learning the right things with your limited time.
...
- [Tailwind CSS](https://tailwindcss.com/docs/installation) — CSS Framework that makes styling really easy. I always suggest to know CSS well before you start taking shortcuts!
...
- Vercel (frontend hosting) – Awesome, free, web hosting that really intuitive.
- Heroku (backend hosting) – I'm very unfamiliar with backend hosting services.
...
3. Start coding.
4. Run into walls. Text your friends, read documentation (!!!), use all your resources.
...
I strongly suggest to read documentation obsessively, and look at popular open source code bases to see how experienced engineers write code.

**GOALS:**

1. Learn how to think about your app's flows **before** building (in Figma, during design phase).
...
3. Learn how to get code to do what you want it to do.
   - A sub goal here is to learn how to be clean about your code. You should care about things down to your [directory structure](<https://en.wikipedia.org/wiki/Directory_(computing)>). [Here](https://github.com/marcelo-cm/workman) an example of what I think is a good directory structure.
...
- Learn what it means to write clean code and it's importance.
- Learn how to make your code legible.
- Learn basic do-s and don't-s of writing code.

When in doubt about **anything**, literally just ChatGPT it, or email me. I am not kidding, I emailed 120+ engineers during my journey for advice.
...
- Integrate tools like ESLint and Prettier to maintain consistent code quality.
...
- Add WebSocket or Socket.io to enable features like live notifications or chat.
