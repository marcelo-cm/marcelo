      ...
      <div className="w-full max-w-[700px] flex flex-col items-center gap-2">
        ...
        <article
          className="w-full max-w-[700px] 
                    prose prose-p:text-white prose-p:font-light prose-p:leading-snug
                    ...
                    prose-ol:text-white
                    prose-ul:text-white
                    prose-li:text-white prose-li:pl-4 prose-li:marker:text-[#a0a0a0] prose-li:marker:font-light
