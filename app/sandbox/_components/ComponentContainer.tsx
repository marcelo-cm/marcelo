...
export const ComponentContainer = ({
  ...
  const detailsChildren = React.Children.toArray(children)[1];
  const learnings =
  ...
  return (
    <div className={`relative ${className}`}>
      <div className="w-full border border-[1px] border-[#2e2e2e] border-dashed hover:border-dotted px-8 py-16 rounded-lg flex flex-row justify-center">
